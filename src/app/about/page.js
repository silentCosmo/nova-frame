...
export default function About() {
    return (
        <div className=''>
            ...
            <section className="md:my-14 md:px-44">
            <section className="md:p-16 p-8 mx-auto py-8 bg-gradient-to-r from-purple-950 to-blue-900 font-light leading-8 rounded-sm  tracking-wider text-slate-100">
                <div className="my-14 md:px-48">
